...
const Popup = ({ open, close, navigate }) => {
  return open ? (
    <section className="fixed top-0 p-4 left-0 w-screen h-screen z-999 flex items-center justify-center ">
      <div className=" relative w-full h-full md:max-h-[600px] md:max-w-[500px] max-h-full max-w-full bg-blue-100 flex items-center justify-center  flex-col opacity-100 p-4 rounded-2xl shadow-2xl border-blue-700 border">
        ...
        <div className="text-center">
          ...
          <h1 className="text-green-600 mt-1">1 YEAR</h1>
